        ...
        try {
            ...
            console.log({
                ...
                end_date: editTask.end_date
                    ? editTask.end_date.toISOString().split("T")[0]
                    : null,
            });
    ...
    return (
        <div className="reminder-card" key={task.id}>
            ...
            <div>
                ...
                {days === 1 && <span className="tomorrow">🟠 Due Tomorrow</span>}

                {days === 2 && <span className="twodays">🟡 Due in 2 Days</span>}

                {days === 5 && <span className="fivedays">🟢 Due in 5 Days</span>}
            </div>
        </div>
    );
})}
